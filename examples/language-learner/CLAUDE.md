...
AI-powered language learning with flashcards and generated sentences. For solo learners who want contextual practice.
...
1. Run full verification: TBD (determine after tech stack decision)
2. `git tag v{X.Y}`
...
Tech stack: TBD — queue item #5 will resolve this.
Language: TBD
Framework: TBD
Test runner: TBD
Linter: TBD

> This section will be populated after discovery. Add entries as
> decisions are made. Format: convention — why.
