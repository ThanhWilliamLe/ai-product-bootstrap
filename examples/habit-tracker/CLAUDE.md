...
Mobile-first habit tracker with streaks, reminders, and simple analytics. Built with React Native + Expo for a solo developer.
...
Versions are cheap. Ship often. 0.1, 0.2, ... 1.0. Don't overthink scope.

## Conventions

- TypeScript strict mode — catch bugs at compile time, not runtime
- Expo managed workflow — no native module ejection
- expo-sqlite for local persistence — no backend, all data on-device
- Functional components with hooks — no class components
- Kebab-case file names, named exports — consistency across codebase
